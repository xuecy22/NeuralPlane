...
class hifi_F16():
    def __init__(self, device=device):
        ...
        self.delta_Cx_lef_model.load_state_dict(torch.load(path + '/model/delta_Cx_lef.pth'))
        self.delta_Cz_lef_model = MLP(2, 1, [20, 10, 5]).to(device=device)
        self.delta_Cz_lef_model.load_state_dict(torch.load(path + '/model/delta_Cz_lef.pth'))
        self.delta_Cm_lef_model = MLP(2, 1, [20, 10, 5]).to(device=device)
        self.delta_Cm_lef_model.load_state_dict(torch.load(path + '/model/delta_Cm_lef.pth'))
        self.delta_Cy_lef_model = MLP(2, 1, [20, 10, 5]).to(device=device)
        self.delta_Cy_lef_model.load_state_dict(torch.load(path + '/model/delta_Cy_lef.pth'))
        self.delta_Cn_lef_model = MLP(2, 1, [20, 10, 5]).to(device=device)
        self.delta_Cn_lef_model.load_state_dict(torch.load(path + '/model/delta_Cn_lef.pth'))
        self.delta_Cl_lef_model = MLP(2, 1, [20, 10]).to(device=device)
        self.delta_Cl_lef_model.load_state_dict(torch.load(path + '/model/delta_Cl_lef.pth'))
        ...
        self.delta_Cy_r30_model.load_state_dict(torch.load(path + '/model/delta_Cy_r30.pth'))
        self.delta_Cn_r30_model = MLP(2, 1, [20, 10, 5]).to(device=device)
        self.delta_Cn_r30_model.load_state_dict(torch.load(path + '/model/delta_Cn_r30.pth'))
        self.delta_Cl_r30_model = MLP(2, 1, [20, 10, 5]).to(device=device)
        self.delta_Cl_r30_model.load_state_dict(torch.load(path + '/model/delta_Cl_r30.pth'))
        self.delta_Cy_a20_model = MLP(2, 1, [20, 10, 10]).to(device=device)
        self.delta_Cy_a20_model.load_state_dict(torch.load(path + '/model/delta_Cy_a20.pth'))
        self.delta_Cy_a20_lef_model = MLP(2, 1, [20, 20, 10]).to(device=device)
        self.delta_Cy_a20_lef_model.load_state_dict(torch.load(path + '/model/delta_Cy_a20_lef.pth'))
        self.delta_Cn_a20_model = MLP(2, 1, [20, 10, 5]).to(device=device)
        self.delta_Cn_a20_model.load_state_dict(torch.load(path + '/model/delta_Cn_a20.pth'))
        self.delta_Cn_a20_lef_model = MLP(2, 1, [20, 20, 10]).to(device=device)
        self.delta_Cn_a20_lef_model.load_state_dict(torch.load(path + '/model/delta_Cn_a20_lef.pth'))
        self.delta_Cl_a20_model = MLP(2, 1, [20, 10]).to(device=device)
        self.delta_Cl_a20_model.load_state_dict(torch.load(path + '/model/delta_Cl_a20.pth'))
        self.delta_Cl_a20_lef_model = MLP(2, 1, [20, 20, 10]).to(device=device)
        self.delta_Cl_a20_lef_model.load_state_dict(torch.load(path + '/model/delta_Cl_a20_lef.pth'))
