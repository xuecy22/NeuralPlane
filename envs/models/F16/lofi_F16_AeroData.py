...
def dmomdcon(alpha, beta):
    ALA = [[-.041, -.052, -.053, -.056, -.050, -.056, -.082, -.059, -.042, -.038, -.027, -.017],
    ...
    ALR = [[.005, .017, .014, .010, -.005, .009, .019, .005, 0.0, -.005, -.011, .008],
    ...
    ANA = [[.001, -.027, -.017, -.013, -.012, -.016, .001, .017, .011, .017, .008, .016],
    ...
    ANR = [[-.018, -.052, -.052, -.052, -.054, -.049, -.059, -.051, -.030, -.037, -.026, -.013],
...
def cz(alpha, beta, dele):
    A = [
        .770, .241, -.100, -.416, -.731, -1.053, -1.366, -1.646, -1.917,
        -2.120, -2.248, -2.229
    ]
    s = .2 * (alpha)
    k = int(s)
